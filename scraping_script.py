...
# 0.0.0.0/0
engine = create_engine('mysql+mysqlconnector://root:root@34.67.31.144:3306/trabalho')
...
hockey_team_df.to_sql("hockey_team",con=engine,  if_exists='replace', index=False, 
    dtype={'nome': String(60), 
           'year': Integer(), 
           'wins': Integer(), 
           'losses': Integer(), 
           'ot_losses': Integer(), 
